          ...
          <Card className= "flex flex-col shadow-none border-none">
            <div className="mt-8 space-y-4 mb-4">
              ...
              <p className="text-lightBlue font-medium mt-5 mb-4 text-center">
                ¿Que te parece si nos cuentas en qué rango se encuentran tus niveles de ingreso mensual
              </p>
            </div>
            <div className="justify-end space-y-6 grid-rows-12 mt-5">
              <div className="space-y-2">
                <InputRadioCheckbox type="radio" name="incomeRanges" label='Menos de 279.718 (salario mínimo)' onChange={handleChange} value={IncomeRanges.OPTION_ONE} />
                ...
                <InputRadioCheckbox type="radio" name="incomeRanges" label='Más de 1.400.000' onChange={handleChange} value={IncomeRanges.OPTION_THREE} />
              </div>
              <div>
                <Button
