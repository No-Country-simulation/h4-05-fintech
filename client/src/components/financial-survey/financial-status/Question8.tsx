...
import { SavingPlans, IFinancialSurvey } from "@/interfaces/profile.interfaces";
...
const Question8 = () => {
  ...
  const handleNextQuestion = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    navigate('/financial-survey/financial-status/5', { state: { prev: true } });
  }
    ...
    <main>
      <header className="py-3 -mb-4">
        <div className="flex justify-between items-center space-x-3">
          ...
          <progress className="progressBar" value={8} max={10}>{8}%</progress>
        </div>
      </header>
          ...
          <Card className= "flex flex-col shadow-none border-none">
            ...
            <div className="justify-end space-y-6 grid-rows-12 mt-5">
              <div className="space-y-2">
                <InputRadioCheckbox type="radio" name="savingsPlans" label='Sí' onChange={handleChange} value={SavingPlans.YES} />
                <InputRadioCheckbox type="radio" name="savingsPlans" label='No' onChange={handleChange} value={SavingPlans.NO} />
              </div>
              <div>
                <Button
