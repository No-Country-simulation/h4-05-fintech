      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className= "flex flex-col shadow-none border-none">
          <div className=" justify-end grid-rows-12">
            <p className="text-lightBlue text-center">Para ofrecerte un servicio bien personalizado y que te sirva de verdad, nos gustaría saber un poco más sobre vos. ¿Qué te parece si arrancamos con algunas preguntas?</p>
          </div>
